...
```
urbandictionary <command> [arguments] [flags]
```

Run `urbandictionary <command> --help` for the full flag list on any command. This
...
per operation you declare in `urbandictionary/domain.go`.
