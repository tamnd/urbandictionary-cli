...
// HTTP behaviour is covered in urbandictionary_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "urbandictionary://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("urbandictionary", "about")
	if err != nil || got.String() != "urbandictionary://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want urbandictionary://page/about", got.String(), err)
	}
}
